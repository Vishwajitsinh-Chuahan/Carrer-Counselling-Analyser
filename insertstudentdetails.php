...
if(isset($_POST['submit']))
{
  ...
  $linkedin_link=$_POST['link'];
    ...
    $query1="INSERT INTO personalinformation (fullname,student_id,contactnumber,email,result_hsc,medium,meritrank,admissiontype,currentsemester,sem1,sem2,sem3,sem4,sem5,sem6,sem7,sem8,year1,year2,year3,year4,interest,counsellor) VALUES('$full_name','$student_id','$contact','$email','$hsc','$medium','$meritrank','$admission','$currentsem','$sem1','$sem2','$sem3','$sem4','$sem5','$sem6','$sem7','$sem8','$year1','$year2','$year3','$year4','$interest','$counsellor' )";
    $data=mysqli_query($conn,$query1);

    $query2 = "INSERT INTO technologystand (cp,web,ai,android,otherfield,any_score,prefer,student_id) VALUES ('$cp','$web','$ai','$android','$otherfield','$any_score','$prefer','$student_id')";
  ...
  foreach($_POST['nptelcourses'] as $key => $value)
  {
      ...
      $nptelquery = "INSERT INTO nptel (nptelcourses,nscore,student_id) VALUES ('$nptel_courses', '$nptel_score','$student_id')";
  ...
  foreach($_POST['course'] as $key => $value)
  {
      ...
      $coursequery = "INSERT INTO professionalcourses (course,result,student_id) VALUES ('$professional_courses', '$p_result','$student_id')";
  ...
  foreach($_POST['project'] as $key => $value)
  {
      ...
      $projectquery = "INSERT INTO research (project,tech,student_id) VALUES ('$project_name', '$tech_name','$student_id')";
      $query_run = mysqli_query($conn, $projectquery);
  }

    $githubquery="INSERT INTO github (githubprojectrepo,contributions,githubstars,link,student_id) VALUES ('$repo','$contributions','$stars','$linkedin_link','$student_id')";
